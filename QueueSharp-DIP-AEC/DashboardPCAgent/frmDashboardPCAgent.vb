...
Public Class frmDashboardPCAgent
    ...
    Private Sub StartFlash()
        ...
        Pross.StartInfo.FileName = Application.StartupPath & "\DIP_AEC-Dashboard.exe"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Button1.Text = "OK" Then
            QueryData()
            If Process.GetProcessesByName("DIP_AEC-Dashboard").Length = 0 Then
                StartFlash()
            End If
        Else
            Try
                For Each p As Process In Process.GetProcessesByName("DIP_AEC-Dashboard")
                    p.Kill()
                Next
    ...
    Private Sub QueryData()
        ...
        IsConnect = Engine.Common.FunctionEng.CheckShopConnect()

        If IsConnect = True Then
            Try
                RefreshTime = Convert.ToInt16(Engine.Common.ShopConnectDBENG.GetShopConfig("DashboardRefreshMinute", "DashboardPCAgent", "frmDashboardPCAgent_StartDashboard"))
    ...
    Sub GeneratePieChart()
        ...
        Try
            ...
            Dt = Engine.Common.ShopConnectDBENG.ExecuteTable(strSql, "DashboardPCAgent", "frmDashboardPCAgent_GeneratePieChart")
    ...
    Sub GenerateService()
        ...
        Try
            ...
            Dim dt As New DataTable
            dt = Engine.Common.ShopConnectDBENG.ExecuteTable(strSql, "DashboardPCAgent", "Form1_GenerateService")
            If dt.Rows.Count > 0 Then
    ...
    Sub GenerateSummary()
        ...
        Try
            ...
            Dim dt As New DataTable
            dt = Engine.Common.ShopConnectDBENG.ExecuteTable(strSql, "DashboardPCAgent", "Form1_GenerateSummary")
            If dt.Rows.Count > 0 Then
            ...
            dt2 = Engine.Common.ShopConnectDBENG.ExecuteTable(strSql, "DashboardPCAgent", "Form1_GenerateSummary")
    ...
    Private Sub Timer1_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        If DateAdd(DateInterval.Minute, RefreshTime, LastUpdateOn) < DateTime.Now Then
            ...
            Timer1.Enabled = True
            RefreshTime = Convert.ToInt16(Engine.Common.ShopConnectDBENG.GetShopConfig("DashboardRefreshMinute", "DashboardPCAgent", "Form1_Timer1.Tick"))
    ...
    Private Sub btnConfig_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfig.Click
        ...
        If frm.DialogResult = Windows.Forms.DialogResult.Yes Then
            RefreshTime = Convert.ToInt16(Engine.Common.ShopConnectDBENG.GetShopConfig("DashboardRefreshMinute", "Dashboard", "Form1_btnConfig.Click"))
        End If
    End Sub

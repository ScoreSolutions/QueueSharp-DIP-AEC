...
Public Class frmMainDisplay
    ...
    '        dt = Engine.Common.ShopConnectDBENG.ExecuteTable("exec SP_MainDisplaySerenadeClub", "MainDisplayFlash", "frmMainDisplayAIS3G_Timer3_Tick")
    ...
    Private Sub Timer1_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        Try
            Dim dt As New DataTable
            dt = Engine.Common.ShopConnectDBENG.ExecuteTable("exec SP_MainDisplay", "MainDisplay", "frmMainDisplay_Timer1.Tick")
    ...
    '    Try
    '        Dim dt As New DataTable
    '        dt = Engine.Common.ShopConnectDBENG.ExecuteTable("exec SP_MainDisplaySerenade", "MainDisplayFlash", "frmMainDisplayAIS3G_Timer2.Tick")

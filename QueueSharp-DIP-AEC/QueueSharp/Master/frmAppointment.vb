...
Public Class frmAppointment
    ...
    Private Sub btnGen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGen.Click
        ...
        If ShopOpen < GetShopConfig("s_open", ApplicationName, "frmAppointment_btnGen.Click") Then
        ...
        If ShopClose > GetShopConfig("s_close", ApplicationName, "frmAppointment_btnGen.Click") Then
    ...
    Sub GenSlot()
        ...
        Dim ShopCloseTime As Date = DateAdd(DateInterval.Minute, (CInt(cbCloseShop.Text) + CInt(cbSlot.Text)) * -1, CDate(GetShopConfig("s_close", ApplicationName, "frmAppointment_GenSlot")))

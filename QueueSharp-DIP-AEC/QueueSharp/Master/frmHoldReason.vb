...
Public Class frmHoldReason
    ...
    Private Sub ShowData()
        sql = "select id,name,productive,active_status,case when productive = 1 then 'Productive' else 'Non Productive' end as pro,case when active_status = 1 then 'Active' else 'Inactive' end as status from MS_HOLD_REASON order by name"
    ...
    Private Function Validation() As Boolean
        ...
        If CheckDuplicate("MS_HOLD_REASON", "name", txtName.Text.Trim, txtID.Text) = True Then
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If Validation() Then
            ...
            Dim lnq As New LinqDB.TABLE.MsHoldReasonLinqDB

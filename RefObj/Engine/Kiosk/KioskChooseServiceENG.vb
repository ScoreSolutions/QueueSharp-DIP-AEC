...
Namespace Kiosk
    Public Class KioskChooseServiceENG : Inherits KioskBaseENG
        ...
        Public Function FindQueueNo(ByVal mobile As String, ByVal ItemID As Int32, ByVal TypeID As Int32, ByVal SoftwareName As String, ByVal FunctionName As String) As String
            Dim ret As String = ""
            Dim sql As String = ""
            Dim txtQueue As String = ""
            sql = "select txt_queue,count_queue_by_segment  from TB_ITEM where id = " & ItemID
            Dim dt As New DataTable
            dt = getDataTable(sql, SoftwareName, "frmChooseService_btnOK.Click")
            ...
            If txtQueue.Trim <> "" Then
                ...
                Else
                    ...
                    End If
                    dt = getDataTable(sql, SoftwareName, "frmChooseService_FindQueueNo")
        ...
        Public Sub UpdateQueueNo(ByVal SoftwareName As String, ByVal FunctionName As String, ByVal vDateNow As String, ByVal CurrDB As String, ByVal MobileNo As String, ByVal AllService As String, ByVal Segment As String, ByVal QueueNo As String, ByVal ItemID As Integer)
            Dim sql As String = ""
            'Update Queue No.
        ...
        'Public Sub PrintQueueWalkInTicket(ByVal e As System.Drawing.Printing.PrintPageEventArgs, ByVal SoftwareName As String, ByVal FunctionName As String, ByVal PrintQueue As Print)
        ...
        '    Dim vDateNow As DateTime = FindDateNow(SoftwareName, "frmChooseService_pd.PrintPage")
        '    If Language = "TH" Then
        ...
        Public Function CheckAppointmentSchedule(ByVal SoftwareName As String, ByVal FunctionName As String) As DataTable
            Dim sql As String = ""
            Dim dt As New DataTable
            ...
            Return dt
        End Function
        Public Function CheckQueueCustomerInShop(ByVal MobileNo As String, ByVal SoftwareName As String, ByVal FunctionName As String) As DataTable
        ...
        Public Function CheckServiceAppointment(ByVal serviceId As String, ByVal INIFileName As String, ByVal SoftwareName As String, ByVal FunctionName As String) As DataTable
            ...
            Dim dt As New DataTable
            dt = getDataTable(Sql, SoftwareName, "frmChooseService_btnAppointment_Click")
            Return dt
        End Function
    End Class
End Namespace

...
Namespace Kiosk
    Public Class KioskRegisterENG : Inherits KioskBaseENG
        ...
        Public Sub DeleteQueueIfNoQueue(ByVal SoftwareName As String, ByVal FunctionName As String)
        ...
        Public Shared Function GetServiceRegister(ReqTypeID As Long, PatentTypeID As Long) As DataTable
        ...
        '    dtS = getDataTable(sqlS, SoftwareName, FunctionName)
        ...
        '    qDt = getDataTable(qSql, SoftwareName, FunctionName)
        '    Return qDt
        'End Function
        ...
        '    dt = getDataTable(sql, SoftwareName, "frmRegister_FindQueueNoAppointment")
        ...
        '        If Engine.Common.ShopConnectDBENG.GetShopConfig("IsPACapture", SoftwareName, FunctionName) = "Y" Then
        '            ret = True
        '        End If
        '    Else
        '        ret = True

...
Namespace Kiosk
    Public Module KioskModule
        ...
        'Public CustomerTypeID As Int32 = DefaultCustomerTypeID
        ...
        'Public Function CheckConn(ByVal SoftwareName As String, ByVal FunctionName As String, ByVal SQL As String) As Boolean
        '    If CheckDBConn(Conn, SoftwareName, FunctionName, SQL) = False Then
        '        Return False
        '    End If
        '    Return True
        'End Function
...
#Region "Manage Query"
        ...
        Public Function getDataTable(ByVal SQL As String, ByVal SoftwareName As String, ByVal FunctionName As String) As DataTable
            Return Engine.Common.FunctionEng.GetShopDataTable(SQL)
        End Function

        Public Sub executeSQL(ByVal SQL As String, ByVal SoftwareName As String, ByVal FuncationName As String)
            If SQL.Trim <> "" Then
                Engine.Common.FunctionEng.ExecuteShopNonQuery(SQL)
            End If
        End Sub
...
#End Region
        ...
        Public Function CheckUpdateConfig(ByVal SoftwareName As String, ByVal FunctionName As String) As Boolean
            Dim ret As Boolean = False
            'If CheckConn(SoftwareName, FunctionName, "") = True Then
            Try
                Dim sql As String = ""
                Dim dt As New DataTable
                '************** Check Configuration ***************
                sql = "select * from tb_setting"
                dt = getDataTable(sql, SoftwareName, FunctionName)
...
#Region "Insert Service & Log"
        ...
        '    sql &= " values(@ID,'" & FixDB(QueueNo) & "','" & FixDB(Mobile) & "'," & CustomerTypeID & "," & ItemID & ",'" & FixDate(FindDateNow(INIFileName, SoftwareName)) & " " & AppTime & "','" & Segment & "',0," & vDateNow & ",1,0, " & vDateNow & ",'" & NetworkType & "')"
        '    executeSQL(sql, INIFileName, SoftwareName)
        '    InsertLog(QueueNo, CustomerID, UserID, ItemID, 0, 1, "", vDateNow, CurrDB, SoftwareName, FunctionName)

        'End Sub

        Sub InsertService(ByVal CustomerID As String, ByVal CustomerTypeID As Integer, ByVal ItemID As Integer, ByVal CustomerName As String, ByVal Segment As String, ByVal QueueNo As String, ByVal UserID As Int32, ByVal NetworkType As String, ByVal vDateNow As String, ByVal CurrDB As String, ByVal SoftwareName As String, ByVal FunctionName As String)
            ...
            'executeSQL(sql, SoftwareName, "KioskModule.InsertService")
            'InsertLog(QueueNo, CustomerID, UserID, ItemID, 0, 1, "", vDateNow, CurrDB, SoftwareName, FunctionName)

        End Sub

        'Insert Log กรณีที่มีการเปลี่ยนแปลงสถานะของลูกค้า
        Sub InsertLog(ByVal QueueNo As String, ByVal CustomerID As String, ByVal UserID As Integer, ByVal ItemID As Integer, ByVal CounterID As Integer, ByVal Status As Integer, ByVal Flag As String, ByVal vDateNow As String, ByVal CurrDB As String, ByVal SoftwareName As String, ByVal FunctionName As String)
            Dim sql As String = ""
            Dim dt As New DataTable
            ...
            Dim vID As Long = FindID("TB_LOGFILE", SoftwareName, FunctionName)
            ...
            executeSQL(sql, SoftwareName, FunctionName)
...
#End Region
        ...
        'หา rowID ของ Tabel
        Public Function FindID(ByVal TableName As String, ByVal SoftwareName As String, ByVal FunctionName As String) As String
            Dim id As String = ""
            Try
                Dim sql As String = ""
                Dim dt As New DataTable
        ...
        Public Function FindDateNow(ByVal SoftwareName As String, ByVal FunctionName As String) As Date
            Dim sql As String = ""
            Dim dt As New DataTable

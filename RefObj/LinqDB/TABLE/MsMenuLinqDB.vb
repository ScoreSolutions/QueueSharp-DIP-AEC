...
Namespace TABLE
    ...
    Public Class MsMenuLinqDB
        ...
        Public Property UPDATE_DATE() As  System.Nullable(Of DateTime) 
            ...
            End Set
        End Property 
        <Column(Storage:="_MENU_TYPE", DbType:="VarChar(50) NOT NULL ",CanBeNull:=false)>  _
        Public Property MENU_TYPE() As String
            ...
            End Set
        End Property 
        <Column(Storage:="_MENU_NAME", DbType:="VarChar(50) NOT NULL ",CanBeNull:=false)>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the record of MS_MENU by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of MS_MENU by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsMenuLinqDB
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(5) = New SqlParameter("@_MENU_TYPE", SqlDbType.VarChar)
            cmbParam(5).Value = _MENU_TYPE

            cmbParam(6) = New SqlParameter("@_MENU_NAME", SqlDbType.VarChar)
            cmbParam(6).Value = _MENU_NAME
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As MsMenuLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, MENU_TYPE, MENU_NAME)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.CREATE_BY, INSERTED.CREATE_DATE, INSERTED.UPDATE_BY, INSERTED.UPDATE_DATE, INSERTED.MENU_TYPE, INSERTED.MENU_NAME
                Sql += " VALUES("
                sql += "@_CREATE_BY" & ", "
                sql += "@_CREATE_DATE" & ", "
                sql += "@_UPDATE_BY" & ", "

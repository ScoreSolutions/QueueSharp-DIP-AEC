...
Namespace TABLE
    'Represents a transaction for MS_USER_SERVICE_SCHEDULE table LinqDB.
    '[Create by  on May, 22 2015]
    Public Class MsUserServiceScheduleLinqDB
        Public sub MsUserServiceScheduleLinqDB()

        End Sub 
        ' MS_USER_SERVICE_SCHEDULE
        Const _tableName As String = "MS_USER_SERVICE_SCHEDULE"
        ...
        Public Property MS_SERVICE_ID() As Long
            ...
            End Set
        End Property 
        <Column(Storage:="_PRIORITY", DbType:="SmallInt NOT NULL ",CanBeNull:=false)>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into MS_USER_SERVICE_SCHEDULE table successfully.
        ...
        '/// Returns an indication whether the current data is updated to MS_USER_SERVICE_SCHEDULE table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from MS_USER_SERVICE_SCHEDULE table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of MS_USER_SERVICE_SCHEDULE by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of MS_USER_SERVICE_SCHEDULE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsUserServiceScheduleLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of MS_USER_SERVICE_SCHEDULE by specified condition is retrieved successfully.
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(8) = New SqlParameter("@_PRIORITY", SqlDbType.SmallInt)
            cmbParam(8).Value = _PRIORITY
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As MsUserServiceScheduleLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table MS_USER_SERVICE_SCHEDULE
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SERVICE_DATE, MS_USER_ID, MS_SERVICE_ID, PRIORITY, ACTIVE_STATUS)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.CREATE_BY, INSERTED.CREATE_DATE, INSERTED.UPDATE_BY, INSERTED.UPDATE_DATE, INSERTED.SERVICE_DATE, INSERTED.MS_USER_ID, INSERTED.MS_SERVICE_ID, INSERTED.PRIORITY, INSERTED.ACTIVE_STATUS
                Sql += " VALUES("
                sql += "@_CREATE_BY" & ", "
                sql += "@_CREATE_DATE" & ", "
                sql += "@_UPDATE_BY" & ", "
        ...
        'Get update statement form table MS_USER_SERVICE_SCHEDULE
        ...
        'Get Delete Record in table MS_USER_SERVICE_SCHEDULE
        ...
        'Get Select Statement for table MS_USER_SERVICE_SCHEDULE
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SERVICE_DATE, MS_USER_ID, MS_SERVICE_ID, PRIORITY, ACTIVE_STATUS FROM " & tableName
                Return Sql
            End Get
        End Property
